...
/**
 * Created by Adi on 7/4/2015.
 */
public class MyUtils {
    public static void showKeyboard(Context pActivity, View pView) {
        if (pView == null) {
    ...
    public static void hideKeyboard(View pView, Context pActivity) {
//        if (pView == null) {
//            pView = pActivity.getWindow().getCurrentFocus();
//        } else {
            InputMethodManager imm = (InputMethodManager) pActivity
...
//        }
    ...
    public static void hideKeyboard(Activity pActivity,View pView) {
        if (pView == null) {
            pView = pActivity.getWindow().getCurrentFocus();
        }
        if(pView != null){
